...
int main() {
  ...
  else printf("Funcao retornou false (9)\n");
  exibirLog(f);
  if(aumentarPrioridade(f, 11, 4)) printf("(10) Funcao retornou true\n");
  else printf("Funcao retornou false (10) \n");
  exibirLog(f);
  ...
  else printf("Funcao retornou false (17)\n");
  exibirLog(f);
  ...
  else printf("Funcao retornou false (19)\n");
  exibirLog(f);
  if(reduzirPrioridade(f, 4, 1)) printf("(20) Funcao retornou true\n");
  else printf("Funcao retornou false (20)\n");
  exibirLog(f);
  return 0;
}
